...
public class SplitCircularLL {
	...
	*/
	...
	public static void main(String[] args)
	{
            ...
            SplitCircularLL.head = new Node(12);
            SplitCircularLL.head.next = new Node(56);
            SplitCircularLL.head.next.next = new Node(2);
            SplitCircularLL.head.next.next.next = new Node(11);
            SplitCircularLL.head.next.next.next.next = SplitCircularLL.head;

        System.out.println("Original Circular Linked list ");
        list.printList(SplitCircularLL.head);
