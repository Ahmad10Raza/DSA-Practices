...
public class Count_Min_Reversals {
    static int countMinReversals(String expr) {
        ...
        // this will be the minimum number of reversals required to balance the expression
    ...
    static int countMinReversals_GFG(String expr)
    {
        int len = expr.length();
